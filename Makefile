...
run-flake:
	$(call execute_in_env, flake8 --max-line-length 99 ./src/*/*.py ./test/*/*.py)

## Run the unit tests
unit-test:
	$(call execute_in_env, PYTHONPATH=${PYTHONPATH} pytest -v)

## Run the unit test singular
test-one:
...
## Make the database locally
db: 
	$(call execute_in_env, PYTHONPATH=${PYTHONPATH} psql -f test_db.sql)
